    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="user.php">
                ...
                <div class="sidebar-brand-text mx-3">Catatan Perjalanan<sup></sup></div>
            </a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                  ...
                  <h3>Aplikasi CatatanPerjalananSederhana</h3>
                    ...
                    <div class="h5 mb-4 text-gray-800">
                        <?php 
                            if(!empty(@$_GET['url'])){
                                ...
                                echo "Selamat datang di Aplikasi Catatan Perjalanan Sederhana. ";
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Firli</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
